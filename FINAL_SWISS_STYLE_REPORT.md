...
- ✅ ChatSidebar: прямоугольные элементы списка чатов + система уведомлений
...
- ✅ Прямоугольные красные badges с подсчетом сообщений
- ✅ Общий индикатор в заголовке "ЧАТЫ"
- ✅ Пульсирующая анимация для новых сообщений
- ✅ Автоматическая очистка при открытии чата
- ✅ Swiss Style дизайн без скруглений

#### **Звуковые уведомления**
- ✅ Звуковой сигнал при получении новых сообщений
- ✅ Прямоугольная кнопка управления звуком в TopBar
- ✅ Красный акцент для активного состояния
...
- ✅ **Индивидуальные счетчики** для каждого чата
- ✅ **Общий индикатор** в заголовке списка чатов  
- ✅ **Умные уведомления** только для неоткрытых чатов
- ✅ **Автоматическая очистка** при выборе чата
- ✅ **Push-уведомления** с preview сообщения

### **Swiss Style дизайн уведомлений**
- ⬜ **Прямоугольные badges** без скруглений
- 🔴 **Красный акцент** (#FF0000) для привлечения внимания
- ⚡ **Пульсирующая анимация** для новых сообщений
- 📊 **Четкая типографика** - Helvetica Neue, жирный шрифт
- 🎯 **Функциональность** - показывает точное количество (1, 2, 3... 99+)

### **Компоненты**
```jsx
// Прямоугольный badge с числом
<Box sx={{ 
  minWidth: 24, 
  height: 20, 
  ...
  <Typography>{count > 99 ? '99+' : count}</Typography>
</Box>
```
